...
<head>
    ...
    <link href="node_modules/sweetalert2/dist/sweetalert2.min.css" rel="stylesheet" media="all">
                    ...
                    <ul class="list-unstyled navbar__list">
                        <li>
                            <a href="inventario.php">
                                <i class="fas fa-chart-bar"></i>Inventario</a>
                        </li>
                        <li>
                            <a href="ventas.php">
                        ...
                        <li>
                            <a href="egresos.php">
                                <i class="far fa-check-square"></i>Egresos</a>
                        </li>
                        <li>
                            <a href="finanzas.php">
                                <i class="fas fa-calendar-alt"></i>Finanzas</a>
                        </li>
                        <li>
